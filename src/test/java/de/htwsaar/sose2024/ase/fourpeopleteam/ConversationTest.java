...
public class ConversationTest {
    ...
    public void messageEqualityTest() {
        Conversation.Message baseMsg = new Conversation.Message("system", "A sample message.");
        Conversation.Message identicalBaseMsg = new Conversation.Message("system", "A sample message.");
        Conversation.Message changedContentMsg = new Conversation.Message("system", "A different message.");
        Conversation.Message changedRoleMsg = new Conversation.Message("user", "A sample message.");
